//                                                             call
/*
    use case of call : to hold the reference of the inner function present outside
*/
function setUsername(username) {
    this.username = username;
}
function createUser(username, email,password) {
    setUsername.call(this, username)            // 'this' from createUser is passed in
    this.email = email;
...
/*
    ...
    7. To overcome this problem, we use call method to preserve reference from setUsername method and use 'this' to refer current context of createUser (i.e. it will say use this parameter for current context)
    8. Even if setUsername function poped-out the call stack, it's reference will remain in the createUser with help of call method and 'this' will use setUsername's username in createUser
*/